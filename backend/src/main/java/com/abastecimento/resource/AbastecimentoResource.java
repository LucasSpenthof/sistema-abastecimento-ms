...
import com.abastecimento.services.AbastecimentoService;
...
public class AbastecimentoResource {
	...
	@PutMapping("/{id}")
	public ResponseEntity<AbastecimentoDTO> update(@PathVariable Long id,@Valid @RequestBody AbastecimentoDTO dto){
